...
@Module({ imports: [PrismaModule, ChatModule], controllers: [ZaloWebhookController], providers: [ZaloSignatureService, ZaloWebhookService, ZaloWebhookProcessorService, ZaloTokenEncryptionService, ZaloTokenService, ZaloOaClientService] })
